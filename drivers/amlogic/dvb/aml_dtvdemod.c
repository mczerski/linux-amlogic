/*
 * drivers/amlogic/dvb/aml_dtvdemod.c
 *
...
AML_DEMOD_ATTACH_FUNCTION(aml_m1);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl101);
AML_DEMOD_ATTACH_FUNCTION(aml_avl6211);
AML_DEMOD_ATTACH_FUNCTION(aml_si2168);
AML_DEMOD_ATTACH_FUNCTION(aml_ite9133);
AML_DEMOD_ATTACH_FUNCTION(aml_ite9173);
AML_DEMOD_ATTACH_FUNCTION(aml_dib8096);
AML_DEMOD_ATTACH_FUNCTION(aml_atbm8869);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl241);
AML_DEMOD_ATTACH_FUNCTION(aml_avl68xx);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl683);
AML_DEMOD_ATTACH_FUNCTION(aml_atbm8881);
AML_DEMOD_ATTACH_FUNCTION(aml_atbm7821);
AML_DEMOD_ATTACH_FUNCTION(aml_avl6762);
AML_DEMOD_ATTACH_FUNCTION(aml_cxd2856);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl248);
AML_DEMOD_ATTACH_FUNCTION(aml_m88dm6k);
AML_DEMOD_ATTACH_FUNCTION(aml_mn88436);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl212c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl213c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl214c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl252c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl254c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl256c);
AML_DEMOD_ATTACH_FUNCTION(aml_mxl258c);
AML_DEMOD_ATTACH_FUNCTION(aml_si2169);
AML_DEMOD_ATTACH_FUNCTION(aml_avl6221c);
		...
		int attch)
{
	...
	case AM_DTV_DEMOD_M1:
		attch ? (p = aml_dvb_attach(aml_m1_attach, cfg)) :
				aml_dvb_detach(aml_m1_attach);
		break;
	case AM_DTV_DEMOD_MXL101:
		attch ? (p = aml_dvb_attach(aml_mxl101_attach, cfg)) :
				aml_dvb_detach(aml_mxl101_attach);
		break;
	case AM_DTV_DEMOD_AVL6211:
		attch ? (p = aml_dvb_attach(aml_avl6211_attach, cfg)) :
				aml_dvb_detach(aml_avl6211_attach);
		break;
	case AM_DTV_DEMOD_SI2168:
		attch ? (p = aml_dvb_attach(aml_si2168_attach, cfg)) :
				aml_dvb_detach(aml_si2168_attach);
		break;
	case AM_DTV_DEMOD_ITE9133:
		attch ? (p = aml_dvb_attach(aml_ite9133_attach, cfg)) :
				aml_dvb_detach(aml_ite9133_attach);
		break;
	case AM_DTV_DEMOD_ITE9173:
		attch ? (p = aml_dvb_attach(aml_ite9173_attach, cfg)) :
				aml_dvb_detach(aml_ite9173_attach);
		break;
	case AM_DTV_DEMOD_DIB8096:
		attch ? (p = aml_dvb_attach(aml_dib8096_attach, cfg)) :
				aml_dvb_detach(aml_dib8096_attach);
		break;
	case AM_DTV_DEMOD_ATBM8869:
		attch ? (p = aml_dvb_attach(aml_atbm8869_attach, cfg)) :
				aml_dvb_detach(aml_atbm8869_attach);
		break;
	case AM_DTV_DEMOD_MXL241:
		attch ? (p = aml_dvb_attach(aml_mxl241_attach, cfg)) :
				aml_dvb_detach(aml_mxl241_attach);
		break;
	case AM_DTV_DEMOD_AVL68xx:
		attch ? (p = aml_dvb_attach(aml_avl68xx_attach, cfg)) :
				aml_dvb_detach(aml_avl68xx_attach);
		break;
	case AM_DTV_DEMOD_MXL683:
		attch ? (p = aml_dvb_attach(aml_mxl683_attach, cfg)) :
				aml_dvb_detach(aml_mxl683_attach);
		break;
	case AM_DTV_DEMOD_ATBM8881:
		attch ? (p = aml_dvb_attach(aml_atbm8881_attach, cfg)) :
				aml_dvb_detach(aml_atbm8881_attach);
		break;
	case AM_DTV_DEMOD_ATBM7821:
		attch ? (p = aml_dvb_attach(aml_atbm7821_attach, cfg)) :
				aml_dvb_detach(aml_atbm7821_attach);
		break;
	case AM_DTV_DEMOD_AVL6762:
		attch ? (p = aml_dvb_attach(aml_avl6762_attach, cfg)) :
				aml_dvb_detach(aml_avl6762_attach);
		break;
	case AM_DTV_DEMOD_CXD2856:
		attch ? (p = aml_dvb_attach(aml_cxd2856_attach, cfg)) :
				aml_dvb_detach(aml_cxd2856_attach);
		break;
	case AM_DTV_DEMOD_MXL248:
		attch ? (p = aml_dvb_attach(aml_mxl248_attach, cfg)) :
				aml_dvb_detach(aml_mxl248_attach);
		break;
	case AM_DTV_DEMOD_M88DM6K:
		attch ? (p = aml_dvb_attach(aml_m88dm6k_attach, cfg)) :
				aml_dvb_detach(aml_m88dm6k_attach);
		break;
	case AM_DTV_DEMOD_MN88436:
		attch ? (p = aml_dvb_attach(aml_mn88436_attach, cfg)) :
				aml_dvb_detach(aml_mn88436_attach);
		break;
	case AM_DTV_DEMOD_MXL212C:
		attch ? (p = aml_dvb_attach(aml_mxl212c_attach, cfg)) :
				aml_dvb_detach(aml_mxl212c_attach);
		break;
	case AM_DTV_DEMOD_MXL213C:
		attch ? (p = aml_dvb_attach(aml_mxl213c_attach, cfg)) :
				aml_dvb_detach(aml_mxl213c_attach);
		break;
	case AM_DTV_DEMOD_MXL214C:
		attch ? (p = aml_dvb_attach(aml_mxl214c_attach, cfg)) :
				aml_dvb_detach(aml_mxl214c_attach);
		break;
	case AM_DTV_DEMOD_MXL252C:
		attch ? (p = aml_dvb_attach(aml_mxl252c_attach, cfg)) :
				aml_dvb_detach(aml_mxl252c_attach);
		break;
	case AM_DTV_DEMOD_MXL254C:
		attch ? (p = aml_dvb_attach(aml_mxl254c_attach, cfg)) :
				aml_dvb_detach(aml_mxl254c_attach);
		break;
	case AM_DTV_DEMOD_MXL256C:
		attch ? (p = aml_dvb_attach(aml_mxl256c_attach, cfg)) :
				aml_dvb_detach(aml_mxl256c_attach);
		break;
	case AM_DTV_DEMOD_MXL258C:
		attch ? (p = aml_dvb_attach(aml_mxl258c_attach, cfg)) :
				aml_dvb_detach(aml_mxl258c_attach);
		break;
	case AM_DTV_DEMOD_SI2169:
		attch ? (p = aml_dvb_attach(aml_si2169_attach, cfg)) :
				aml_dvb_detach(aml_si2169_attach);
		break;
	case AM_DTV_DEMOD_AVL6221C:
		attch ? (p = aml_dvb_attach(aml_avl6221c_attach, cfg)) :
				aml_dvb_detach(aml_avl6221c_attach);
		break;
	default:
		p = NULL;
		break;
